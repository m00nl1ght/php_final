...
<main class="shop-page">
  ...
  <section class="shop container">
    <?php include $_SERVER['DOCUMENT_ROOT'] . '/view/layout/filter.php'; ?>

    <div class="js-shop__wrapper shop__wrapper">
      <?php include $_SERVER['DOCUMENT_ROOT'] . '/view/layout/shop_wrapper.php'; ?>
    </div>
  </section>
  ...
  <section class="shop-page__order" hidden="">
    <div class="shop-page__wrapper">
      ...
      <form action="/controllers/orderForm.php" method="post" class="custom-form js-order">
