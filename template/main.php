  ...
  <section class="shop container">
    <section class="shop__filter filter">
      <form class="js-filter__form">
        <?php include $_SERVER['DOCUMENT_ROOT'] . '/template/category.php'; ?>
        ...
        <fieldset class="custom-form__group">
          <input type="checkbox" name="new" id="new" class="custom-form__checkbox" <?= (isset($_GET['filter']) && $_GET['filter'] == 'new')?"checked":"" ?>>
          <label for="new" class="custom-form__checkbox-label custom-form__info" style="display: block;">Новинка</label>
          <input type="checkbox" name="sale" id="sale" class="custom-form__checkbox" <?= (isset($_GET['filter']) && $_GET['filter'] == 'sale')?"checked":"" ?>>
    ...
    <?php include $_SERVER['DOCUMENT_ROOT'] . '/template/shop_wrapper.php'; ?>
